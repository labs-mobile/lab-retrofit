...
class TaskAdapter(taskRepository : TaskRepository ) : RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return taskRepository.taskDao.reasult_tasks.value!!.size
    }

    override fun onBindViewHolder(taskViewHolder: TaskViewHolder, position: Int) {
        val task = this.taskRepository.taskDao.reasult_tasks.value!![position]
